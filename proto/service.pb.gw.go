...
func RegisterEchoerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EchoerServer) error {
	...
	mux.Handle("GET", pattern_Echoer_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
var (
	pattern_Echoer_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"echo", "word"}, "", runtime.AssumeColonVerbOpt(true)))
)
